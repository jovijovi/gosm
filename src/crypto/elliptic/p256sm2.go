...
type sm2P256Curve struct {
	RInverse *big.Int
	*CurveParams
	SMa, SMb, SMgx, SMgy SM2P256FieldElement
}
...
func initP256Sm2() {
	...
	SM2P256.BitSize = 256
	SM2P256FromBig(&SM2P256.SMa, A)
	SM2P256FromBig(&SM2P256.SMgx, SM2P256.Gx)
	SM2P256FromBig(&SM2P256.SMgy, SM2P256.Gy)
	SM2P256FromBig(&SM2P256.SMb, SM2P256.B)
}
...
func (curve sm2P256Curve) IsOnCurve(X, Y *big.Int) bool {
	...
	SM2P256Mul(&a, &curve.SMa, &x) // a = a * x
	SM2P256Add(&x3, &x3, &a)
	SM2P256Add(&x3, &x3, &curve.SMb)
